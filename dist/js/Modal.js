...
if (process.env.NODE_ENV !== 'production') {
  ...
  module.exports = __webpack_require__(123)(ReactIs.isElement, throwOnDirectAccess);
} else {
...
var DialogComponent = function (_PureComponent) {
...
var m=__webpack_require__(18),n=__webpack_require__(20),p=__webpack_require__(13),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(47),B=__webpack_require__(18),C=__webpack_require__(13),ba=__webpack_require__(48),da=__webpack_require__(49),ea=__webpack_require__(50),fa=__webpack_require__(51),ia=__webpack_require__(52),D=__webpack_require__(20);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(40)(Function.call, __webpack_require__(60).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _Skeleton = __webpack_require__(133);
...
var _Dialog = __webpack_require__(62);

var _Dialog2 = _interopRequireDefault(_Dialog);

var _DefImg = __webpack_require__(139);
...
var ModalComponent = function (_PureComponent) {
...
var _throttleDebounce = __webpack_require__(125);

var _scrollThrough = __webpack_require__(126);

var _scrollThrough2 = _interopRequireDefault(_scrollThrough);
...
var Modal = function (_PureComponent) {
    ...
    _createClass(Modal, [{
        ...
        value: function createFooter() {
            ...
            if (!buttons.length && !modalType) return false;else {
                return modalType === 'full' ? _react2.default.createElement('div', { className: this.props.prefixCls + '__closeicon', onClick: this.close }) : _react2.default.createElement(
                    'div',
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                children = _props2.children,
                maskCloseable = _props2.maskCloseable,
            ...
            return _react2.default.createElement(
                _Dialog2.default,
                {
                    ...
                    closeFn: this.close,
                    boxClassName: (0, _classnames2.default)(prefixCls + '__' + (modalType === 'full' ? 'fullbox' : 'box'), className),
...
var scrollThrough = {
  ...
  fixBody: function fixBody() {
    var cls = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "popup-open";
  ...
  relaxBody: function relaxBody() {
    ...
    //回到原来滚动的高度
    $body.scrollTop = document.documentElement.scrollTop = -parseFloat(document.body.style.top);
    document.body.style.top = '';
  }
};

exports.default = scrollThrough;
...
var PopupComponent = function (_PureComponent) {
    _inherits(PopupComponent, _PureComponent);
...
var _SkeletonBox = __webpack_require__(135);

var _SkeletonBox2 = _interopRequireDefault(_SkeletonBox);

var _SkeletonItem = __webpack_require__(136);
...
var SkeletonBox = function (_Component) {
    _inherits(SkeletonBox, _Component);

    function SkeletonBox(props) {
        _classCallCheck(this, SkeletonBox);

        return _possibleConstructorReturn(this, (SkeletonBox.__proto__ || Object.getPrototypeOf(SkeletonBox)).call(this, props));
    }

    _createClass(SkeletonBox, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                style = _props.style,
            ...
            return _react2.default.createElement(
                'div',
                { style: _extends({}, style, { alignItems: align, justifyContent: justify, flexDirection: direction }), className: selectClassName },
                children
            );
        }
    }]);
...
SkeletonBox.defaultProps = {
    prefixCls: _prefix2.default.cls + '-skeleton-box',
    className: '',
    style: {},
    justify: 'flex-start',
    align: 'flex-start',
...
var SkeletonItem = function (_PureComponent) {
    ...
    function SkeletonItem(props) {
        ...
        return _possibleConstructorReturn(this, (SkeletonItem.__proto__ || Object.getPrototypeOf(SkeletonItem)).call(this, props));
    }
    ...
    _createClass(SkeletonItem, [{
        ...
        value: function render() {
            ...
            var selectClassName = (0, _classnames2.default)(prefixCls, className);
            return _react2.default.createElement('div', { style: _extends({}, style), className: selectClassName });
        }
    }]);
...
SkeletonItem.defaultProps = {
    prefixCls: _prefix2.default.cls + '-skeleton-item',
    className: '',
    style: {}
};
...
function isDOM(s) {
    ...
    return s && (typeof s === 'undefined' ? 'undefined' : _typeof(s)) === 'object' && s.nodeType === 1 && typeof s.nodeName === 'string';
}
...
var _danarrrUidesign2 = _interopRequireDefault(_danarrrUidesign);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Modal = _danarrrUidesign2.default.Modal;
...
var App = function (_Component) {
  ...
  (0, _createClass3.default)(App, [{
    key: 'showModal',
    value: function showModal(configProps) {
      this.setState({
        modalVisible: true,
    ...
    value: function render() {
      ...
      var setModalConfig = {
        defalutProps: {
          title: '只有标题的dialog',
          buttons: [{ text: '关闭', onPress: function onPress() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { onClick: this.showModal.bind(this, setModalConfig.defalutProps) },
              '\u53EA\u6709\u6807\u9898'
            ),
            _react2.default.createElement(
              'button',
              { onClick: this.showModal.bind(this, setModalConfig.allShowProps) },
              '\u6709\u6807\u9898\u548C\u6B63\u6587'
            ),
            _react2.default.createElement(
              'button',
              { onClick: this.showModal.bind(this, setModalConfig.buttonsProps) },
              '\u53CC\u6309\u94AE'
            ),
            _react2.default.createElement(
              'button',
              { onClick: this.showModal.bind(this, setModalConfig.radioProps) },
              '\u5355\u9009\u6846'
            ),
            _react2.default.createElement(
              'button',
              { onClick: this.showModal.bind(this, setModalConfig.maskCloseProps) },
              '\u70B9\u51FBmask\u5173\u95ED\u5F39\u7A97'
            ),
            _react2.default.createElement(
              'button',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { onClick: this.showModal.bind(this, setModalConfig.fullModalProps) },
              '\u5168\u5C4F\u6A21\u6001\u6846'
            )
          )
        ),
        _react2.default.createElement(Modal, (0, _extends3.default)({}, this.state.configProps, {
          visible: this.state.modalVisible
        }))
      );
    }
