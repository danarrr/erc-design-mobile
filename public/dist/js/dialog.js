...
var Dialog = _danarrrUidesign2.default.Dialog;
...
var App = function (_Component) {
    ...
    (0, _createClass3.default)(App, [{
        key: 'showDialog',
        value: function showDialog(configProps) {
            this.setState({
                visible: true, // 展示弹框
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { onClick: this.showDialog.bind(this, setDialogConfig.defalutProps) },
                            '\u9ED8\u8BA4Dialog'
                        ),
                        _react2.default.createElement(
                            'button',
                            { onClick: this.showDialog.bind(this, setDialogConfig.allShowProps) },
                            '\u6709\u6807\u9898\u6709\u6B63\u6587\u7684Dialog'
                        )
                    )
                ),
                _react2.default.createElement(Dialog, (0, _extends3.default)({}, this.state.configProps, {
                    visible: this.state.visible,
                    closeFn: this.closeDiglog.bind(this)
                }))
            );
